      ...
      {maxIndex > 0 && (
        <div className="flex items-center justify-end gap-3 mt-6">
          <button
            ...
            onClick={prev}
            disabled={index === 0}
            className="w-10 h-10 rounded-full border border-neutral-300 flex items-center justify-center text-neutral-700 hover:bg-[#D52E12] hover:text-white hover:border-[#D52E12] transition-colors disabled:opacity-30 disabled:pointer-events-none"
          >
